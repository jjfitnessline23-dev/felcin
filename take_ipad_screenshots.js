...
// 12.9-inch iPad Pro slot in App Store Connect — required for iPad support
// Viewport 1024×1366 at 2x = 2048×2732 final PNG (App Store required size)
const WIDTH = 1024;
const HEIGHT = 1366;
...
(async () => {
  ...
  console.log("Connected. Taking screenshots at 1024×1366 @2x = 2048×2732 (12.9\" iPad Pro)...\n");
  ...
  console.log("\nDone! Upload the PNGs from felcin/screenshots-ipad/ to the 12.9\" iPad Pro slot in App Store Connect.");
